...
function GetLoadNav() {
    ...
    $.each(data, function (i) {
        ...
        if (row.parentGuid == "0") {
            _html += '<li>';
            _html += '<a data-id="' + row.sysModuleGuid + '" href="#" class="dropdown-toggle"><i class="' + row.sysModuleIcon + '"></i><span>' + row.sysModuleName + '</span><i class="fa fa-angle-right drop-icon"></i></a>';
            ...
            if (childNodes.length > 0) {
                ...
                $.each(childNodes, function (i) {
                    ...
                    _html += '<li>';
                    _html += '<a class="menuItem" data-id="' + subrow.sysModuleGuid + '" href="' + subrow.sysModuleUri + '" data-index="' + subrow.sortCode + '">' + subrow.sysModuleName + '</a>';
                    _html += '</li>';
                });
                _html += '</ul>';
            }
